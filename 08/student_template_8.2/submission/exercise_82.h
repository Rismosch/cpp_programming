...
/**
 * @brief Sorts the given list of points by the x-coordinate and returns the
 sorted copy.
...
/**
 * @brief Sorts the given list of points by the y-coordinate and returns the
 * sorted copy. Use std::sort() to implement this!
 *
 * @param points The input list of points.
 * @return std::vector<Point> Sorted copy of the points.
 */
...
/**
 * @brief Computes the median in x- and y-direction and returns both in one
 * Point where the x-variable is the x-median and the y-variable is the
 * y-median.
 *
