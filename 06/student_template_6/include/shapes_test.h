...
// do _not_ check if they are implemented correctly
...
#ifdef TEST_TASK_4
  // there is nothing here - everything is already declared - you only need to
  // fill in the functions use the tests on Infomark or check the output on the
  // console
#endif
}
