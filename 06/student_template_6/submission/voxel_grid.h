...
public:
  /// implicit conversion from shape to voxel grid - this declaration disables
...
/// append a string representation of the voxel slice to the stream (e.g.
/// VoxelSlice vs; std::cout << vs;)
std::ostream &operator<<(std::ostream &ostream, const VoxelSlice &slice);

/// append a string representation of the voxel grid to the stream (e.g.
/// VoxelGrid vg; std::cout << vg;)
