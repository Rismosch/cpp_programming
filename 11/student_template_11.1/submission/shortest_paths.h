...
public:
  ...
  public:
    ...
    const std::optional<float> &operator[](size_t i) const {
...
public:
  ...
  std::vector<size_t> compute_shortest_path(const std::string &from,
...
private:
  // adjacency_matrix - contains all locations and a full list of distances
  // between all nodes
